...
const filtercheck_field_info sinsp_filter_check_event_fields[] =
{
	...
	{PT_CHARBUF, EPF_NONE, PF_NA, "syscall.type", "For system call events, the name of the system call (e.g. 'open'). Unset for other events (e.g. switch). Use this field instead of evt.type if you need to make sure that the filtered/printed value is actually a system call."},
...
const filtercheck_field_info sinsp_filter_check_container_fields[] =
{
	...
	{PT_CHARBUF, EPF_NONE, PF_NA, "container.image", "the container image name (e.g. foo/foo:latest for docker, )."},
	...
	{PT_CHARBUF, EPF_NONE, PF_NA, "container.image.repository", "the container image repository (e.g. foo/foo)."},
